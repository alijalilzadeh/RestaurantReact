...
const LinkToMenu = () => {
  ...
  return (
    <Link to='/menu' className="flex items-center justify-center rounded-xl p-4 w-140 h-20 mb-8 relative bg-[#e2d8b7] animated" reloadDocument>
      ...
      <div className="flex items-start justify-between w-full">
        ...
        <SlArrowRight className="flex self-center text-[#FFFEF6]" />
      </div>
    </Link>
  );
};
