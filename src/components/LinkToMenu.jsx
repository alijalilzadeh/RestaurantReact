...
const LinkToMenu = () => {
  ...
  return (
    <Link to='/menu' className="flex items-center justify-center rounded-xl p-4 w-140 h-20 mb-8 relative transition duration-200 group shadow-md hover:bg-[#F9EEC9] bg-[#d5c89e] animated" reloadDocument>
