...
const ContactUs = () => {
  ...
  const socialNetData = [
    {
      link: "https://www.instagram.com/gulustangarden?igsh=NTc4MTIwNjQ2YQ==",
    },
    {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-140 h-auto rounded-xl bg-white p-4 shadow-[0px_4px_26px_0px_rgba(0,_0,_0,_0.1)] mb-15">
